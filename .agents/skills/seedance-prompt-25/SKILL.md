...
the prompt, or an **audio-first pipeline** where dialogue is generated by
Seed Audio (cross-lingual) and passed as `reference_audio`.
...
Taglish code-switching guidance, and a full audio-first pipeline. Load that
